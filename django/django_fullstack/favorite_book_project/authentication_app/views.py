...
def register_user(request):
    if request.method == 'POST':
        ...
        if errors:
            ...
            new_user = Users.objects.create(first_name = request.POST['f_name'], last_name = request.POST['l_name'], email = request.POST['email'], password= Users.objects.hash_user_input(request.POST['password']))
