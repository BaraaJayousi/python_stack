...
# Chaining example 1
result = math_dojo.add(10).subtract(5).add(3)
print("Chaining example 1 result:", result)  # Expected output: 8
math_dojo.result = 0
# Chaining example 2
result = math_dojo.subtract(20).add(5).subtract(3).add(2)
